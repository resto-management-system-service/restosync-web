...
/**
 * Suggest the next available table name for a zone
 */
export const zonesControllerGetNextTableName = <ThrowOnError extends boolean = false>(options: Options<ZonesControllerGetNextTableNameData, ThrowOnError>): RequestResult<ZonesControllerGetNextTableNameResponses, ZonesControllerGetNextTableNameErrors, ThrowOnError> => (options.client ?? client).get<ZonesControllerGetNextTableNameResponses, ZonesControllerGetNextTableNameErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
